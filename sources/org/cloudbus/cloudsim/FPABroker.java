...
public class FPABroker  extends SimEntity  {
	...
	public FPABroker(String name) throws Exception {
		super(name);
...
//	}
	...
	protected void createPopulation()
	{
		...
		Log.printLine("AVG " + this.avg);
		Log.printLine("cloudsize " + getCloudletList().size());
		Log.printLine("VM " + getVmsCreatedList().size());
		
		int []cloudletCount=new int[getVmsCreatedList().size()];
		Log.printLine("Solcount " + solutioncount);
		...
		{
			System.out.println("SOLUTION-"+k+" "+Population.get(k));
		}
	...
	//fitness of any solution
		//////////////// Maybee we can do smth here, add a threshold
	...
	protected ArrayList<ArrayList<Integer>> localPollination(ArrayList<ArrayList<Integer>> sol1,ArrayList<ArrayList<Integer>> sol2)
	{
	...
	protected ArrayList<ArrayList<Integer>> globalPollination(ArrayList<ArrayList<Integer>> sol1,ArrayList<ArrayList<Integer>> sol2)
	{
		//initialize a 2d arraylist to store new solution
        ArrayList<ArrayList<Integer>> newsol=new ArrayList<ArrayList<Integer>>();
