...
import org.cloudbus.cloudsim.FPABroker;
import org.cloudbus.cloudsim.Vm;
import org.cloudbus.cloudsim.VmsCreator;
import org.cloudbus.cloudsim.core.CloudSim;


public class FPAClass {
...
////// VM
	...
	public static void main(String[] args) {
	    ...
	    private static  FPABroker createBroker(){

	    	FPABroker broker = null;
	        try {
			broker = new FPABroker("Broker");
			} catch (Exception e) {
				e.printStackTrace();
				return null;
			}
