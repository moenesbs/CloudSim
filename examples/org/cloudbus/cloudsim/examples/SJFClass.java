...
import org.cloudbus.cloudsim.SJFBroker;
...
public class SJFClass {
	...
	public SJFClass(int reqTasks, int reqVms,int pesNumber, long[] length,int ram, int PEVM, int nb, int ramDC, int mips)
	{
    ...
    private  SJFBroker createBroker(){
