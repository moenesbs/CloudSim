...
public class MaxminClass {
		...
		public MaxminClass(int reqTasks, int reqVms, int pesNumber, long[] length,int ram, int PEVM, int nb, int ramDC, int mips)
		{
		...
		public void  simulate()
		{
	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	Log.printLine("Max Min finished!");
	    ...
	    private  MaxMinBroker createBroker(){
