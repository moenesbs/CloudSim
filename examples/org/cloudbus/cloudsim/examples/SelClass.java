...
import org.cloudbus.cloudsim.SelectiveBroker;
...
public class SelClass {
	...
	public SelClass(int reqTasks, int reqVms,int pesNumber, long[] length,int ram, int PEVM, int nb, int ramDC, int mips)
	{
	...
	public void  simulate()
	{
		...
		Log.printLine("Starting Selective...");
        ...
        try {
        	// First step: Initialize the CloudSim package. It should be called
            	...
            	Log.printLine("Selective finished!");
    ...
    private  SelectiveBroker createBroker(){
    ...
    private  void printCloudletList(List<Cloudlet> list) {
        ...
        String indent = "    ";
        Log.printLine();
        Log.printLine("========== OUTPUT SELECTIVE ==========");
