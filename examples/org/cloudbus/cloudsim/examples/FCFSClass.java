...
public class FCFSClass {
		...
		public FCFSClass(int reqTasks, int reqVms, int pesNumber, long[] length,int ram, int PEVM, int nb, int ramDC, int mips)
		{
	    ...
	    private   FCFSBroker createBroker(){
